    ...
    return(
        ...
        <div className="flex flex-row justify-between items-center w-full flex-wrap bg-blend-color">
            <div className="flex flex-col items-center w-full">
                <h1 className="w-5/10 mt-[5vh] mb-[20vh] text-center text-5xl text-black border-green-500 border-2 rounded-lg">
                    A react router + djangorestframework application.
                </h1>
            </div>
            <p className="w-10/10 mb-[20vh] text text-black text-xl border-teal-400 rounded-lg border-2">
            ...
            <label className="w-5/10 text-green-400 text-[2em] border-3">
